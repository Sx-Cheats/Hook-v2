...
void __fastcall   ffghfgf(Hook_t* myhook, PRegisters registers)
{
    ...
    WriteWordChar((BYTE*)registers->r8, (BYTE*)"Hooked");
...
int main()
{
    auto HMessageBoxA = Hook((DWORD64)GetProcAddress(GetModuleHandleA("USER32.dll"), "MessageBoxTimeoutA") + 0x3, (DWORD64)ffghfgf, 13, "Hook MessageBoxA");
